    ...
    <div className="relative w-full min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-6xl px-6 py-20 text-center text-white">
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-2 leading-tight [text-shadow:_2px_2px_0_rgb(0_0_0),_-1px_-1px_0_rgb(0_0_0),_1px_-1px_0_rgb(0_0_0),_-1px_1px_0_rgb(0_0_0),_1px_1px_0_rgb(0_0_0)]">
              La Parrilla de la Guayaca
            </h1>
            <div className="w-24 h-1 bg-[#F49D00] mx-auto my-4"></div>
            <h2 className="text-3xl md:text-4xl font-medium mb-6" style={{ color: '#F49D00' }}>
              Plato del día
            </h2>

            <div className="mb-10">
              <h3 className="text-2xl md:text-3xl font-bold mb-3 [text-shadow:_0_2px_4px_rgb(0_0_0_/_80%)]" style={{ color: '#F49D00' }}>
                {currentPlato.titulo}
              </h3>
            ...
            <div className="flex justify-center mb-8">
              <button
                className="group inline-flex items-center gap-3 px-10 py-4 rounded-full font-bold text-xl transition-all duration-300 hover:scale-105"
                style={{
      ...
      {platos.length > 1 && (
        <>
          ...
          <button
            ...
            className="hidden md:block absolute left-4 md:left-8 top-1/2 -translate-y-1/2 z-20 bg-black/40 hover:bg-black/60 text-white p-3 rounded-full transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-opacity-50"
            style={{
              '--tw-ring-color': '#F49D00'
          ...
          <button
            ...
            className="hidden md:block absolute right-4 md:right-8 top-1/2 -translate-y-1/2 z-20 bg-black/40 hover:bg-black/60 text-white p-3 rounded-full transition-all duration-300 transform hover:scale-110 focus:outline-none focus:ring-2 focus:ring-opacity-50"
            style={{
              '--tw-ring-color': '#F49D00'
            } as React.CSSProperties}
          ...
          {/* Mobile: Centered arrows at bottom */}
          <div className="md:hidden absolute bottom-8 left-1/2 -translate-x-1/2 z-20 flex gap-4">
            <button
              onClick={goToPrevPlato}
