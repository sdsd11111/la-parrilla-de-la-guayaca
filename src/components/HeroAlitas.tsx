...
interface HeroAlitasProps {
    title: string;
    subtitle: string;
}

export const HeroAlitas = ({ title, subtitle }: HeroAlitasProps) => {
    return (
        <section className="relative h-screen w-full overflow-hidden bg-[#1A1A1A]">
            ...
            >
                ...
                <div className="absolute top-0 left-0 w-full h-full opacity-10">
                    <div className="absolute top-1/4 left-1/4 w-96 h-96 rounded-full bg-[#F49D00] blur-[128px]" />
